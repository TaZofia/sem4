...
def main():
    zad3_path = r"K:\\studia\\sem4\\aisd\\lista2\\zad3"
    results_path = r"K:\studia\sem4\aisd\lista2\zad3\resultsMS"

    generators = {
        "random": os.path.join(zad3_path, "randomGen.exe"),
    }
    algorithms = {
        "Merge Sort": (os.path.join(zad3_path, "mergeSort.exe"), "ms"),
        "mySort": (os.path.join(zad3_path, "mySort.exe"), "mySort"),
    }
